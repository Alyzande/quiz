...
console.log(q5Value);
    ...
    if (result >= 3) {
        document.getElementById("flag").src = "uj.png";
        msg = result + " You are British! Steady on old chap.";
    } else if (result <= 1.8 ) {
        document.getElementById("flag").src = "stars.jpg";
        msg = result + " Y'all American, howdy!";
    } else {
        msg = result + " 2-3.  You're transatlantic! How about a nice Burger King instead?";
    }
